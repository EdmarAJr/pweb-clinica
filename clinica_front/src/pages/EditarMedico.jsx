  ...
  useEffect(() => {
    const fetchMedico = async () => {
      try {
        ...
        navigate(hasRole("ROLE_ADMIN") ? "/medicos" : "/consultas");
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="row justify-content-center">
        <div className="col-md-8">
          <div className="card shadow-sm border-0 p-4">
            <h2 className="text-center fw-bold text-primary mb-4">Editar Médico</h2>
            <form onSubmit={handleSubmit} className="row g-3">
              ...
              <div className="col-md-4">
                ...
                <input name="estado" className="form-control" value={formData.endereco.estado} onChange={handleEnderecoChange} required maxLength={2} />
              </div>

              <div className="col-12 mt-4 d-flex gap-2">
                <button type="button" className="btn btn-secondary flex-grow-1" onClick={() => navigate(hasRole("ROLE_ADMIN") ? "/medicos" : "/consultas")}>Cancelar</button>
